  ...
  return (
    <div className="max-w-3xl mx-auto space-y-10 pb-16 pt-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {/* Email */}
        <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#111111] space-y-2 shadow-sm">
        ...
        <a
          ...
          className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#111111] space-y-2 shadow-sm hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors block"
        >
          <span className="text-xs font-mono text-zinc-500 flex items-center gap-1.5">
            <Github className="w-3.5 h-3.5 text-zinc-700 dark:text-zinc-300" /> GitHub
          </span>
      ...
      <div className="p-6 sm:p-8 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#111111] space-y-6 shadow-sm">
        ...
        {status === 'success' ? (
          <div className="p-6 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-center space-y-2">
            ...
            <button
              ...
              className="mt-3 px-3 py-1 text-xs font-mono rounded bg-zinc-200 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 font-semibold text-xs sm:text-sm hover:opacity-90 transition-opacity disabled:opacity-50"
            >
