...
export const About: React.FC = () => {
  return (
    <div className="max-w-3xl mx-auto space-y-12 pb-16 pt-6">
      {/* Header */}
      <div className="space-y-3 border-b border-zinc-200/60 dark:border-zinc-800/60 pb-8">
        <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-zinc-900 dark:text-zinc-50">
          A little more about me.
        </h1>
        <p className="text-base text-zinc-600 dark:text-zinc-400 leading-relaxed font-mono text-xs sm:text-sm">
        ...
        <div className="space-y-3 text-zinc-700 dark:text-zinc-300 text-sm sm:text-base leading-relaxed">
          ...
          <ul className="space-y-2.5 pl-2">
            <li className="flex items-start gap-2.5">
              ...
              <div>
                <strong className="text-zinc-900 dark:text-zinc-100">Distributed & Background Workloads:</strong> Designing worker pools, idempotent message queues, and lease recovery engines (like <Link to="/projects/pulsemesh" className="text-zinc-900 dark:text-zinc-100 font-medium underline">PulseMesh</Link>).
              </div>
            </li>
            <li className="flex items-start gap-2.5">
              <span className="text-zinc-400 dark:text-zinc-500 font-mono font-bold">→</span>
              <div>
                <strong className="text-zinc-900 dark:text-zinc-100">Data-Intensive Applications:</strong> Timeseries analytics, sensor aggregation, and spatial indexing (like <Link to="/projects/varshanet" className="text-zinc-900 dark:text-zinc-100 font-medium underline">VARSHANET</Link> and <Link to="/projects/ocean-intelligence" className="text-zinc-900 dark:text-zinc-100 font-medium underline">Ocean Intelligence Platform</Link>).
              </div>
            </li>
            <li className="flex items-start gap-2.5">
              <span className="text-zinc-400 dark:text-zinc-500 font-mono font-bold">→</span>
              <div>
                <strong className="text-zinc-900 dark:text-zinc-100">Offline-First & Resilient Clients:</strong> Systems utilizing CRDTs and local indexed storage to stay 100% operational during connectivity loss (like <Link to="/projects/polaris" className="text-zinc-900 dark:text-zinc-100 font-medium underline">POLARIS</Link>).
              </div>
            </li>
            <li className="flex items-start gap-2.5">
              <span className="text-zinc-400 dark:text-zinc-500 font-mono font-bold">→</span>
      ...
      <section className="space-y-4">
        ...
        <div className="p-5 rounded-2xl backdrop-blur-md bg-white/60 dark:bg-zinc-900/40 border border-zinc-200/60 dark:border-white/10 space-y-3 shadow-sm">
          <p className="text-xs sm:text-sm text-zinc-600 dark:text-zinc-400">
            I treat learning as an active daily discipline. My current focus areas include:
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs sm:text-sm">
            <div className="p-3.5 rounded-xl backdrop-blur-sm bg-zinc-50/70 dark:bg-zinc-800/40 border border-zinc-200/60 dark:border-white/5">
      ...
      <section className="space-y-4 pt-4 border-t border-zinc-200/60 dark:border-zinc-800/60">
        <h2 className="text-xs font-mono font-semibold uppercase tracking-wider text-zinc-500">
          Guiding Principles
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {profile.philosophy.map((rule, idx) => (
            <div
              key={idx}
              className="p-4 rounded-xl border border-zinc-200/60 dark:border-white/10 backdrop-blur-md bg-white/60 dark:bg-zinc-900/40 text-xs sm:text-sm text-zinc-700 dark:text-zinc-300 shadow-xs"
            >
      ...
      {/* Contact CTA */}
      <div className="pt-6 flex items-center justify-between border-t border-zinc-200/60 dark:border-zinc-800/60">
