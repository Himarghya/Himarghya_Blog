    ...
    <div className="space-y-20 sm:space-y-28 pb-12">
      ...
      <section className="pt-8 sm:pt-14 max-w-4xl mx-auto space-y-8">
        <div className="space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 text-xs font-mono rounded-full bg-zinc-100 dark:bg-zinc-800/80 border border-zinc-200 dark:border-zinc-700/80 text-zinc-700 dark:text-zinc-300">
        ...
        <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2">
          <Link
            to="/blog"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 font-medium text-sm hover:opacity-90 transition-opacity shadow-sm"
          >
          ...
          <Link
            to="/projects"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-zinc-100 dark:bg-zinc-800/80 text-zinc-900 dark:text-zinc-100 border border-zinc-200 dark:border-zinc-700/80 font-medium text-sm hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors"
          >
          ...
          <div className="flex items-center gap-2 sm:pl-2">
            <a
              ...
              aria-label="GitHub"
              className="p-2.5 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 rounded-lg border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-mono text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 rounded-lg border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
            >
      ...
      <section className="max-w-4xl mx-auto space-y-6 pt-6 border-t border-zinc-200/80 dark:border-zinc-800/80">
        <div className="flex items-center justify-between">
          ...
          <Link
            to="/about"
            className="group flex items-center gap-1 text-xs font-medium text-emerald-600 dark:text-emerald-400 hover:underline"
          >
      ...
      <section className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6">
          {featuredProjects.map((project) => (
            <div
              key={project.slug}
              className="group p-6 sm:p-7 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#111111] hover:border-zinc-300 dark:hover:border-zinc-700 transition-all shadow-sm space-y-4"
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div className="flex items-center gap-3">
                  <Link
                    to={`/projects/${project.slug}`}
                    className="text-lg sm:text-xl font-bold text-zinc-900 dark:text-zinc-100 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors"
                  >
                    {project.name}
                  </Link>
              ...
              <div className="flex items-center justify-between pt-3 border-t border-zinc-100 dark:border-zinc-800/80 text-xs">
                <div className="flex items-center gap-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors"
                  >
        ...
        <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
          {latestArticles.map((article) => (
            <article key={article.slug} className="py-6 first:pt-2 last:pb-2 space-y-2.5">
              ...
              >
                <h3 className="text-base sm:text-lg font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                  {article.title}
                </h3>
      ...
      <section className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {skillGroups.map((group) => (
            <div
              key={group.category}
              className="p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#111111] space-y-3 shadow-sm"
            >
      ...
      <section className="max-w-4xl mx-auto p-6 sm:p-8 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-900/60 dark:to-[#0D0D0E] space-y-4">
        <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">
          Let&apos;s talk.
        </h2>
        ...
        <div className="flex flex-wrap items-center gap-3 pt-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 text-sm hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors font-mono text-xs"
          >
